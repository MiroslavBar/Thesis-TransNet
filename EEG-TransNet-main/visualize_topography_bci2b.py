...
model_path = 'output/bci_iv_2b/TransNet'
specific_folder = '2023-09-18--21-12'
...
def main(config):
    ...
    index = [12, 47, 49]  # for bci competition iv 2b
    ...
    plt.savefig('./right_topology_2b.png', bbox_inches='tight', dpi=1000)
    # plt.show()
